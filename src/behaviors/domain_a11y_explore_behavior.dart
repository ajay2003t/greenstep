...
import 'package:charts_common/common.dart' as common
    show
        ...
        ExploreModeTrigger;
import 'package:flutter/widgets.dart' show Object;
...
class DomainA11yExploreBehavior<D> extends ChartBehavior<D> {
  ...
  final Set<String>
      desiredGestures; // Changed to String as GestureType is removed
  ...
  factory DomainA11yExploreBehavior({
    ...
    final desiredGestures =
        <String>{}; // Changed to String as GestureType is removed
    exploreModeTrigger ??= common.ExploreModeTrigger.pressHold;

    switch (exploreModeTrigger) {
      case common.ExploreModeTrigger.pressHold:
        desiredGestures.add('onLongPress'); // Placeholder for gesture type
        break;
      case common.ExploreModeTrigger.tap:
        desiredGestures.add('onTap'); // Placeholder for gesture type
        break;
    }
